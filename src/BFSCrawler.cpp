...
void BFSCrawler::start_crawling() 
{
...
std::unordered_map<std::string, std::unordered_map<std::string, unsigned int>> BFSCrawler::words_index() const 
{
    return m_words_index;
}

std::unordered_map<std::string, std::string> BFSCrawler::page_titles() const 
{
    return m_page_titles;
}

void BFSCrawler::bfs_crawl(std::vector<std::string> const& a_startUrls) 
{
...
bool BFSCrawler::should_skip_page(std::string const& a_url, unsigned int a_depth) const 
{
...
std::string BFSCrawler::extract_domain(std::string const& a_url) const
{
...
bool BFSCrawler::is_valid_link(std::string const& a_URL) const
{
...
void BFSCrawler::print_information() const
{
